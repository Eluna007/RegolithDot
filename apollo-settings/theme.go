...
// apolloTheme is a Catppuccin Mocha theme for Fyne, mauve-forward to match
...
type apolloTheme struct{}

var _ fyne.Theme = apolloTheme{}
...
func (apolloTheme) Color(name fyne.ThemeColorName, _ fyne.ThemeVariant) color.Color {
	switch name {
...
func (apolloTheme) Font(s fyne.TextStyle) fyne.Resource { return theme.DefaultTheme().Font(s) }
func (apolloTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (apolloTheme) Size(name fyne.ThemeSizeName) float32 {
	switch name {
