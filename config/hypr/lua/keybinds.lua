...
bind_locked_repeat("XF86MonBrightnessUp",   hl.dsp.exec_cmd("qs -c caelestia ipc call brightness set +5%"))
bind_locked_repeat("XF86MonBrightnessDown", hl.dsp.exec_cmd("qs -c caelestia ipc call brightness set 5%-"))
