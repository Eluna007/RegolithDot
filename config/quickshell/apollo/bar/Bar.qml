            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    TrayBtn {
                        ...
                        barColors: root
                        onClicked: root.showToast("Apollo", "Updates available", root.updateCount + " updates are waiting when you have time <3")
                        Layout.alignment: Qt.AlignHCenter
                    }
    ...
    Component {
        ...
        Island {
            ...
            TrayBtn {
                ...
                active: true
                barColors: root
                onClicked: root.showToast("Apollo", "Recording active", "A screen recording app is currently running")
            }
