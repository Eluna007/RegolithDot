...
PanelWindow {
    ...
    // stranded looking at the old one. A native focus dispatch does switch
    // workspace + monitor to bring the window into view, which is what a
    // task switcher actually needs. See services/Hypr.qml.
